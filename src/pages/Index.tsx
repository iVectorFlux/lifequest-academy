  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-life-blue-50 to-white -z-10"></div>
        <div className="absolute right-0 top-0 w-full h-full opacity-10 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-life-blue-300 via-transparent to-transparent -z-10"></div>
        
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-in">
            <Badge className="px-3 py-1.5 bg-life-blue-100 text-life-blue-800 hover:bg-life-blue-200 border-none mb-2">
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Button 
                size="lg" 
                className="bg-life-blue-600 hover:bg-life-blue-700 text-white shadow-md hover:shadow-lg transition-all"
                asChild
              >
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-life-blue-200 text-life-blue-700 hover:bg-life-blue-50 hover:text-life-blue-800 transition-all"
              >
                Learn More
              </Button>
            </div>
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-4 pt-4 text-sm">
              <div className="flex items-center text-muted-foreground">
                <Check className="text-life-blue-600 mr-2 h-5 w-5" />
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-4 border border-gray-100 max-w-xs animate-scale-in">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Learn essential CPR techniques</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4 border border-gray-100 max-w-xs animate-scale-in animation-delay-150">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Earn your BLS certification</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-slide-up">
            <Badge className="px-3 py-1.5 bg-life-blue-100 text-life-blue-800 hover:bg-life-blue-200 border-none mb-3">
              Our Curriculum
            </Badge>
            ...
            {[
              ...
              <Card key={index} className="bg-white border-none shadow-sm hover:shadow-md transition-all animate-slide-up" style={{ animationDelay: `${index * 100}ms` }}>
                <CardContent className="pt-6">
                  <div className="h-12 w-12 rounded-lg bg-life-blue-50 flex items-center justify-center mb-4">
                    {feature.icon}
                  </div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-6 lg:px-8 bg-life-blue-600 text-white">
        <div className="max-w-7xl mx-auto text-center">
          <div className="max-w-3xl mx-auto animate-fade-in">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Become Life Support Certified?</h2>
            <p className="text-life-blue-100 mb-8 text-lg">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="bg-white text-life-blue-700 hover:bg-life-blue-50 border-white"
              asChild
            >
      ...
      <footer className="bg-gray-900 text-gray-300 py-12 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-white text-xl mb-4">LifeSupport</h3>
