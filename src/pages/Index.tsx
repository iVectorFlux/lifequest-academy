...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-20 px-6 lg:px-8 bg-red-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-slide-up">
            <Badge className="px-3 py-1.5 bg-red-100 text-red-800 hover:bg-red-200 border-none mb-3">
              Specialized Training
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Who Are You Looking to Train?</h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
              We offer tailored life support training programs for various organizations and institutions.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description: "Comprehensive training for teachers, administrators, and staff to ensure school safety.",
                buttonText: "School Programs"
              },
              {
                icon: <GraduationCap className="h-16 w-16 text-red-600" strokeWidth={1.5} />,
                title: "Universities & Colleges",
                description: "Campus-wide emergency response training for higher education institutions.",
                buttonText: "University Programs"
              },
              {
                icon: <Building className="h-16 w-16 text-red-600" strokeWidth={1.5} />,
                title: "Private Organizations",
                description: "Customized corporate training to meet workplace safety requirements and regulations.",
          ...
          <div>
            ...
            <div className="flex flex-col space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+919915559657" className="hover:text-white transition-colors">+91 9915559657</a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-red-400" />
                <a href="mailto:contact@truebls.com" className="hover:text-white transition-colors">contact@truebls.com</a>
              </div>
